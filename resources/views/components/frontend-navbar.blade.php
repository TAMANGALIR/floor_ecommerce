<nav class="container flex justify-between items-center py-4">
    ...
    <div>
        ...
        @else
            <img src="{{ asset('images/default-logo.png') }}" class="h-[40px]" alt="Default Company">
        @endif
    </div>
    ...
    <!-- Auth Links -->
    <div class="space-x-4">
        <a href="#" class="text-sm font-medium text-gray-700 hover:text-[var(--color-primary)]">Sign In</a>
        <a href="#" class="text-sm font-medium text-gray-700 hover:text-[var(--color-primary)]">Sign Up</a>
    </div>
</nav>

<x-frontend-layout>
    ...
    <div class="space-y-3">
        <div>
            <label for="name" class="mb-1">Enter your name <span class="text-[blue]">*</span></label>
            <input type="text" name="name" id="name"
                   class="w-full px-2 py-1 border rounded bg-[var(--color-light-grey)]">
        </div>

        <div>
            <label for="email" class="mb-1">Enter your email <span class="text-[blue]">*</span></label>
            <input type="email" name="email" id="email"
                   class="w-full px-2 py-1 border rounded bg-[var(--color-light-grey)]">
        </div>

        <div>
            <label for="shop_type" class="mb-1">Select Shop Type <span class="text-[blue]">*</span></label>
        ...
        <div>
            <label for="shop_name" class="mb-1">Enter your shop name <span class="text-[blue]">*</span></label>
            <input type="text" name="shop_name" id="shop_name"
                   class="w-full px-2 py-1 border rounded bg-[var(--color-light-grey)]">
        </div>

        <div>
            <label for="shop_address" class="mb-1">Enter your shop address <span class="text-[blue]">*</span></label>
            <input type="text" name="shop_address" id="shop_address"
                   class="w-full px-2 py-1 border rounded bg-[var(--color-light-grey)]">
        </div>

        <div>
            <label for="contact_number" class="mb-1">Enter your Contact Number <span class="text-[blue]">*</span></label>
        ...
        <div>
            <button id="submit-btn" type="submit"
                    class="rounded w-full py-2 text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-300">
                Send Request
            </button>
        </div>
    </div>
